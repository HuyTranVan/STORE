...
//                                imageChangeUri = Uri.fromFile(Util.createTempFileOutput());
                                Transaction.startImageChooser(UpdateUserFragment.this, new CallbackUri() {
                                    @Override
                            ...
                            public void Method2(Boolean two) {
                                Transaction.startCamera(UpdateUserFragment.this, new CallbackUri() {
                                    @Override
                                    public void uriRespone(Uri uri) {
                                        imageChangeUri = uri;
                                    }
        ...
        if (requestCode == REQUEST_CHOOSE_IMAGE) {
            if (data != null) {
                CropImage.activity(Uri.parse(data.getData().toString()))
                        ...
                        .start(getActivity(),  UpdateUserFragment.this);
